...
# - run by:
#   - actual train:
#       bash script_ext3/cifar_perf_main_2_ovrno.sh --qtype batch --data cifar10  --model-wm 1.00
#   - only print cmd:
#       bash script_ext3/cifar_perf_main_2_ovrno.sh --qtype debug --data cifar10  --model-wm 1.00
...
bsub_nnodes=1
bsub_w=360
bsub_o="./res/y-log-bsub/output_pbatch_"$DATA"_2_ovrno_%J.txt"
bsub_q="pbatch"
...
# set: CMD_ARGS.
inout_test="     --data-path ./dataset/ --workers 2 --quiet --logg-undovr-freq 100 --meas-no-fperr"
...
pa_upd_topr_dec="--pa-def-dt FP_6_9_0 FP_6_9_0 --pa-upd-schm topr_dec --pa-upd-dts FP_4_3_4 FP_4_3_4 FP_5_2_0 FP_6_9_0" # ours for HFP8.
...
# opt="$opt_256"
opt="$opt_128"
pa_ovr_thrs="--pa-ovr-thrs -999" # no ovr_thrs. NOT -1 to distinguish this case from other no_ovr_thr.
